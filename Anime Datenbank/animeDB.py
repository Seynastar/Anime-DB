...
class AnimeDatabaseApp:
    ...
    def load_key(self):
        with open(r'C:\Users\Anwender\Python Files\Middle Projects\Anime Datenbank\config.json') as config_file:
    ...
    def insertanime(self, name, category, rating): 
            ...
            insert_query = """
            INSERT INTO anime (name, category, rating, created_at) VALUES (%s, %s, %s, %s);
            """
...
class StarRating:
    def __init__(self, master, initial_rating=0.0):
        self.fullstar_image = PhotoImage(file='c:\\Users\\Anwender\\Python Files\\Middle Projects\\Anime Datenbank\\resized_fullstar.PNG')
        self.halfstar_image = PhotoImage(file='c:\\Users\\Anwender\\Python Files\\Middle Projects\\Anime Datenbank\\resized_halfstar.PNG')
        self.emptystar_image = PhotoImage(file='c:\\Users\\Anwender\\Python Files\\Middle Projects\\Anime Datenbank\\resized_emptystar.PNG')
