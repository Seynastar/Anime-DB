...
class StarRating:
    def __init__(self, master, initial_rating=0.0):
        self.fullstar_image = PhotoImage(file='resized_fullstar.PNG')
        self.halfstar_image = PhotoImage(file='resized_halfstar.PNG')
        self.emptystar_image = PhotoImage(file='resized_emptystar.PNG')
