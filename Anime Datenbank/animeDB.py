...
class StarRating:
    def __init__(self, master, initial_rating=0.0):
        ...
        self.fullstar_image = PhotoImage(file=os.path.join(base_dir, 'images', 'fullstar.PNG'))
        self.halfstar_image = PhotoImage(file=os.path.join(base_dir, 'images', 'halfstar.PNG'))
        self.emptystar_image = PhotoImage(file=os.path.join(base_dir, 'images', 'emptystar.PNG'))
